<template>
  <div class="user-profile">
    ...
    @click="isNameShow = true"></van-cell>
    <van-cell title="性别" :value="sex" is-link @click="isGenderShow = true"></van-cell>
    ...
    <van-popup v-model="isNameShow" style="height:100%" position="bottom">
      <UpdateName v-if="isNameShow" @close="isNameShow=false" v-model="userProfile.name"/>
    </van-popup>
    <!-- 修改性别 -->
    <van-popup v-model="isGenderShow"  position="bottom">
      <UpdateGender v-if="isGenderShow" @close="isGenderShow=false" v-model="userProfile.gender"/>
    </van-popup>
  </div>
